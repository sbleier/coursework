...
ggplot(year_data, aes(x=year, y = volume*10000, color = term)) + geom_line() + scale_y_continuous(labels = comma) + scale_color_manual(values = c("1883" = "blue", "1910" = "green", "1950" = "red")) + labs(x = "Year", y="Volume")
```
...
half_life |> filter(half_life == min(half_life))
